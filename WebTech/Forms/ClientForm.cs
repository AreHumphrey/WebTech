...
dbconnection.getConnection());
       ...
       DataGridViewCellEventArgs e)
        ...
        private void NewClientButton_Click(object sender, EventArgs e)
        {
            ...
            string pattern2 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?[А-ЯЁ][а-яё]*,?\s?(д\.?\s?\d{1,3})?\s?(к|стр|корпус|строение)?\.?\s?\d{1,3},?\s?кв\.?\s?\d{1,4},?\s?\d{6}(\W|$)";
            string pattern3 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?(([А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*)|[А-ЯЁ][а-яё]*|\d{1,4}\s?[А-ЯЁ][а-яё]*|[А-ЯЁ][аяё]*\s?\d{1,4}),?\s?(д\.?\s?\d{1,3}(\s?(к|стр|корпус|строение)\.?\s?\d{1,3})?)?,?\s?кв\.?\s?\d{1,4}(\W|$)";
            string pattern4 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?(([А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*)|[А-ЯЁ][а-яё]*|\d{1,4}\s?[А-ЯЁ][а-яё]*|[А-ЯЁ][аяё]*\s?\d{1,4}),?\s?(д\.?\s?\d{1,3}(\s?(к|стр|корпус|строение)\.?\s?\d{1,3})?)?,?\s?\d{6}(\W|$)";
            string pattern5 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?(([А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*)|[А-ЯЁ][а-яё]*|\d{1,4}\s?[А-ЯЁ][а-яё]*|[А-ЯЁ][аяё]*\s?\d{1,4}),?\s?(д\.?\s?\d{1,3}(\s?(к|стр|корпус|строение)\.?\s?\d{1,3})?)?(\W|$)";
       ...
       e)
        ...
        private void Change()
        {
           ...
           selectedRowIDX].Value);
            string pattern = @"^[А-ЯЁ][а-яё]*(?:\s[А-ЯЁ][а-яё]*){2}?\r?$";
            string pattern1 = @"^[А-ЯЁ][а-яё]*(?:\s[А-ЯЁ][а-яё]*){1}?\r?$";
            string pattern2 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?(([А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*)|[А-ЯЁ][а-яё]*|\d{1,4}\s?[А-ЯЁ][а-яё]*|[А-ЯЁ][аяё]*\s?\d{1,4}),?\s?(д\.?\s?\d{1,3}(\s?(к|стр|корпус|строение)\.?\s?\d{1,3})?)?,?\s?кв\.?\s?\d{1,4},?\s?\d{6}(\W|$)";
            string pattern3 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?(([А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*)|[А-ЯЁ][а-яё]*|\d{1,4}\s?[А-ЯЁ][а-яё]*|[А-ЯЁ][аяё]*\s?\d{1,4}),?\s?(д\.?\s?\d{1,3}(\s?(к|стр|корпус|строение)\.?\s?\d{1,3})?)?,?\s?кв\.?\s?\d{1,4}(\W|$)";
            string pattern4 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?(([А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*)|[А-ЯЁ][а-яё]*|\d{1,4}\s?[А-ЯЁ][а-яё]*|[А-ЯЁ][аяё]*\s?\d{1,4}),?\s?(д\.?\s?\d{1,3}(\s?(к|стр|корпус|строение)\.?\s?\d{1,3})?)?,?\s?\d{6}(\W|$)";
            string pattern5 = @"(?i)(\W|^)(г|п|пгт|с|город|село|пос[её]лок|пос[её]лок\sгородского\sтипа)\.?\s?[А-ЯЁ][а-яё]*,?\s?(ул|пер|пл|пр-д|пр-кт|ш|наб|улица|переулок|площадь|проезд|проспект|шоссе|набережная)\.?\s?(([А-ЯЁ][а-яё]*\s[А-ЯЁ][а-яё]*)|[А-ЯЁ][а-яё]*|\d{1,4}\s?[А-ЯЁ][а-яё]*|[А-ЯЁ][аяё]*\s?\d{1,4}),?\s?(д\.?\s?\d{1,3}(\s?(к|стр|корпус|строение)\.?\s?\d{1,3})?)?(\W|$)";
            string pattern6 = @"\+[?\\7\s]+([\(\s\-]?\d+[\)\s\-]?[\d\s\-]+)?";
